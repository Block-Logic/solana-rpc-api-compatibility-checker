...
pub enum MethodExpectation {
    ...
    TokenAccountsByOwner {
        ...
        required_result_attributes: Vec<String>,
        required_context_attributes: Vec<String>,
        required_value_entry_attributes: Vec<String>,
        required_account_attributes: Vec<String>,
        required_token_amount_attributes: Vec<String>,
        expected_account_owner: String,
        expected_data_program: String,
        expected_mint: String,
        expected_token_owner: String,
    },
    MaxRetransmitSlot,
    MaxShredInsertSlot,
    ...
    fn parses_rpc_fixture_with_generalized_schema() {
        ...
        match fixture.expectation.validator {
            ...
            MethodExpectation::TokenAccountsByOwner {
                ...
                required_result_attributes: _,
                required_context_attributes: _,
                required_value_entry_attributes: _,
                required_account_attributes: _,
                required_token_amount_attributes: _,
                expected_account_owner: _,
                expected_data_program: _,
                expected_mint: _,
                expected_token_owner: _,
            } => panic!("expected stringResult validator"),
